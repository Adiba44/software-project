...
"[project]/src/app/api/read-count-summary/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
async function GET(request) {
    ...
    let totalTeacher = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])(`SELECT COUNT(id) as count FROM users WHERE role="teacher" AND isDeleted=0`);
    let totalStudent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])(`SELECT COUNT(id) as count FROM users WHERE role="student" AND isDeleted=0`);
    let totalOther = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])(`SELECT COUNT(id) as count FROM users WHERE role="other" AND isDeleted=0`);
    // Count total muted teacher, student and other users
    let totalMutedTeacher = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])(`SELECT COUNT(id) as count FROM users WHERE role="teacher" AND isMuted=1 AND isDeleted=0`);
    let totalMutedStudent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])(`SELECT COUNT(id) as count FROM users WHERE role="student" AND isMuted=1 AND isDeleted=0`);
    let totalMutedOther = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])(`SELECT COUNT(id) as count FROM users WHERE role="other" AND isMuted=1 AND isDeleted=0`);
    // Count total faculty, department, program
    let totalFaculty = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT COUNT(id) as count FROM faculty WHERE isDeleted=0");
    let totalDepartment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT COUNT(id) as count FROM department WHERE isDeleted=0");
    let totalProgram = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT COUNT(id) as count FROM program WHERE isDeleted=0");
    // Count total active and muted session
    let totalSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT COUNT(id) as count FROM session WHERE isDeleted=0") // active
    ;
    let totalMutedSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT COUNT(id) as count FROM session WHERE isMuted=1 AND isDeleted=0") // muted
    ;
...
//# sourceMappingURL=src_00a59c._.js.map