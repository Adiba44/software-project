...
function _OtherUserTable({
  ...
  Console.component("OtherUserTable");
  ...
  return (
    <div className="w-full h-full px-8 py-6 bg-white dark:bgBlack2 rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-2 text-gray-600">
        <div className="fontGs text-2xl">Others user</div>
        <div className="text-lg">({countSummary.others.total})</div>
      </div>
      ...
      <div className="px-2 py-2.5 pr-6 flex items-center gap-2 border-b border-gray-300 sticky top-[64px] bg-white dark:bgBlack2">
        ...
        <div className="w-[30%]">
          <div className="flex justify-end items-center gap-4">
            <CSVLink data={csvFilesData} filename="all-other-users-data">
          ...
          <div className="pl-6 p-4 pb-3 flex justify-between items-center">
            ...
            <div className="flex items-center gap-5">
              <div className="fontGsm text-gray-500">
                Total {data.length}/{countSummary.others.total}
              </div>
              <div className="fontGsm text-gray-500">
                Muted {countSummary.others.muted}
              </div>
            </div>
              ...
              {data.map((record, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="w-[30%] py-2.5 pr-4 flex justify-end items-center gap-4"></div>
                  </div>
                );
              })}
