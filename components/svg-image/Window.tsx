export default function SvgWindow({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="187"
    ...
    >
      ...
      />
      <path
        d="M50.4067 126.227H156.438"
        stroke="#5F6368"
        strokeWidth="2"
        strokeMiterlimit="10"
      />
      <path
        d="M50.4067 74.0532H156.438"
        stroke="#5F6368"
        strokeWidth="2"
        strokeMiterlimit="10"
      />
...
export function SvgWindowColor({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="187"
