...
"[project]/src/app/api/users/delete-user/[id]/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
async function DELETE(request, { params }) {
    ...
    // Hide the user
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("UPDATE users SET isDeleted=1, updatedAt=CURRENT_TIMESTAMP, updatedBy=? WHERE id=?", [
        loggedUserId,
        id
    ]);
    // If the user is student then decrease session count
    result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT sessionId FROM users WHERE id=? and role=?", [
        id,
        "student"
    ]);
    if (result.length > 0) {
    ...
    // Add history
    await (async ()=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("SELECT name, email, role FROM users WHERE id=?", [
            id
        ]);
        const name = result[0].name;
        const email = result[0].email;
        const text = `${name}(${email}) is deleted`;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$utils$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"])("INSERT INTO history(userId, text, action, undoParams) VALUES (?,?,?,?)", [
            loggedUserId,
            text,
            "Delete",
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$text$2d$encode$2d$decode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encode"])({
                database: "accounts",
                case: "delete user",
                userId: id
            })
...
//# sourceMappingURL=src_0f0fae._.js.map